...
Run locally:   python3 app.py  (port 8888)
...
#
SOURCE_BUCKET    = "rrs-image-source"           # e.g. "mkm-image-source"
PROCESSED_BUCKET = "rrs-image-source-processed" # e.g. "mkm-image-source-processed"
